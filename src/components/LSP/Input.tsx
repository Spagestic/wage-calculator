...
function Input({ isVisible, handleOpen, handleClose }: InputProps) {
      ...
      {!isVisible && (
        ...
        >
          ...
          >
            ...
            <WorkDateInput label="Start working date" value={startDate} onChange={setStartDate} />
            <WorkDateInput label="End working date" value={endDate} onChange={setEndDate} />
            <Text
                align="left"
                size="lg"
                weight={250}
